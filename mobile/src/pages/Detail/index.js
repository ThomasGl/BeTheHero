...
export default function Detail() {
    ...
    const message = `Hello ${incident.name}, I am contacting you about the case "${incident.title}" with the value of ${Intl.NumberFormat('en-US',{ style: 'currency', currency: 'USD'}) .format(incident.value)}`
    ...
    function sendMail() {
        MailComposer.composeAsync({
            subject: `Heros Case: ${incident.title}`,
